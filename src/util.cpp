...
const char * const BITCOIN_CONF_FILENAME = "pitcoin.conf";
const char * const BITCOIN_PID_FILENAME = "pitcoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "PitCoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/PitCoin";
#else
    // Unix
    return pathRet / ".pitcoin";
#endif
#endif
}
