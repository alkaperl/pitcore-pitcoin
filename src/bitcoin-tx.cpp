...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s pitcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  pitcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded pitcoin transaction") + "\n" +
              "  pitcoin-tx [options] -create [commands]   " + _("Create hex-encoded pitcoin transaction") + "\n" +
              "\n";
